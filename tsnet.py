...
train_data = SRDataset('dataset/LR_pre','../LBM/dataset1000/LR_before','../LBM/dataset1000/HR',train=True)
test_data = SRDataset('dataset/LR_pre','../LBM/dataset1000/LR_before','../LBM/dataset1000/HR',train=False)
...
for epoch in range(num_epochs):
    ...
    if loss < best_loss:
        best_loss = loss
        torch.save(net.state_dict(),"tsnet.pth")