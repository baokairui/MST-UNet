...
batch_size = 16
train_data = SRDataset('../LBM/dataset1000/LR','../LBM/dataset1000/HR',train=True)
test_data = SRDataset('../LBM/dataset1000/LR','../LBM/dataset1000/HR',train=False)
...
net = UNetsingle(256, 128, in_channels=1, num_classes=1).to(device)
...
for epoch in range(num_epochs):
    ...
    if loss < best_loss:
        best_loss = loss
        torch.save(net.state_dict(),"single.pth")